...
public class FraudRulesProperties {
    ...
    public double getAmountMaxDecline() {
        return amountMaxDecline;
    }

    public void setAmountMaxDecline(double v) {
        this.amountMaxDecline = v;
    }

    public double getAmountMaxChallenge() {
        return amountMaxChallenge;
    }

    public void setAmountMaxChallenge(double v) {
        this.amountMaxChallenge = v;
    }
    ...
    public void setBlockedCountries(Set<String> s) {
        this.blockedCountries = s;
    }

    public Set<String> getBlockedDevices() {
        return blockedDevices;
    }

    public void setBlockedDevices(Set<String> s) {
        this.blockedDevices = s;
    }
    ...
    public void setBlockedCards(Set<String> s) {
        this.blockedCards = s;
    }
}
